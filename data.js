const data = {
  ThietBi: [
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 1, choice: "Phím điều khiển trò chơi (Joystick)." },
        {
          id: 2,
          choice:
            "Cả Phím điều khiển trò chơi (Joystick) và Găng tay cảm nhận (Data glove).",
        },
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 1,
          choice: "Bi cuộn dưới đáy chuột (Rollers on the bottom of mouse)",
        },
        {
          id: 2,
          choice:
            "Cả Cảm biến quang học (Optical sensor) và Bi cuộn dưới đáy chuột (Rollers on the bottom of mouse)",
        },
    ...
    {
      question:
        "Loại thiết bị nào có thể xoay bằng cách xoay với ngón tay hoặc long bàn tay?",
      choice: [
    ...
    {
      question:
        "Chiết áp được gắn vào phần đế của phím điều khiển trò chơi đề đo?",
      choice: [
    ...
    {
      question:
        "Phím điều khiển trò chơi nhạy cảm áp suất (Pressure-sensitive joysticks) còn được gọi là?",
      choice: [
    ...
    },
    {
      ...
      choice: [
        {
          id: 0,
          choice: `Để khởi tạo các thao tác đồ họa (To initiate graphics operation)`,
        },
        {
          id: 1,
    ...
    {
      question:
        "Thiết bị nào dưới đây có chứa thumbwheel, trackball và mouse ball chuẩn?",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 3,
          choice: "Bộ đệm khung (Frame buffer) & Bộ vi xử lý (Processor)",
        },
      ],
      answer: 0,
    },
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 0,
          choice: "Ống lưu trữ cảnh trực tiếp (Direct-view storage tube)",
        },
    ...
    {
      question:
        "Thiết bị chuyển đổi từ năng lượng điện thành ánh sáng được gọi là?",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        },
        {
          id: 3,
          choice:
            "Cả hệ thống quét mành (Raster-scan system) và hệ thống quét ngẫu nhiên (Random-scan system)",
        },
      ],
      answer: 0,
    },
    ...
    },
    {
      ...
      choice: [
        {
          id: 1,
          choice: "Ống lưu trữ cảnh trực tiếp (Direct view storage tubes)",
        },
        {
          id: 2,
          choice:
            "Thiết bị hiển thị màn hình phẳng (Flat panel display devices)",
        },
        {
          id: 3,
          choice: "Thiết bị hiển thị plasma (Plasma panel display devices)",
        },
        {
          id: 0,
          choice: "Thiết bị hiển thị ba chiều (Three-dimensional devices)",
        },
      ],
      answer: 0,
    },
    ...
    },
    {
      ...
      choice: [
        {
          id: 0,
          choice: "Ứng dụng vẽ đường thẳng (Line-drawing applications)",
        },
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 1, choice: "Máy quét" },
        {
          id: 2,
          choice:
            "Không phải màn hình hiển thị video, cũng không phải máy quét",
        },
        { id: 3, choice: "Máy in" },
      ],
      answer: 0,
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 1, choice: "Thiết bị định vị (Positioning)" },
        {
          id: 3,
          choice:
            "Cả Thiết bị trỏ (Pointing) và Thiết bị định vị (Positioning)",
        },
        {
          id: 2,
  ...
  CacThuatToanToMau: [
      ...
      choice: [
        {
          id: 3,
          choice:
            "Dung lượng cung cấp để lưu trữ 1 điểm ảnh trong bộ đệm khung",
        },
    ...
    },
    {
      ...
      choice: [
        {
          id: 3,
          choice: "Trực tiếp trong bộ đệm khung (Directly in frame buffer)",
        },
    ...
    },
    {
      id: 8,
      question:
        "Với cường độ hiển thị tương ứng với màu cho trước, chỉ số ci được tính như sau",
      choice: [
    ...
    },
    {
      id: 9,
      question:
        "Một người sử dụng có thể thiết lập đầu vào bảng màu trong chương trình ứng dụng PHIGS với hàm",
      choice: [
    ...
    },
    {
      id: 18,
      question:
        "Phép toán được dùng để kết hợp mẫu tô (fill pattern) với mẫu nền (background pattern) là",
      choice: [
    ...
    },
    {
      id: 20,
      question:
        "Các lựa chọn cho tô màu một vùng được định nghĩa bao gồm một lựa chọn giữa __________",
      choice: [
        { id: 0, choice: "Màu đặc hoặc mẫu (Solid color or a pattern fill)" },
        {
          id: 1,
          choice:
            "Các lựa chọn cho các màu và mẫu cụ thể (Choices for particular colors and pattern)",
        },
        {
          id: 3,
          choice:
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 0, choice: "Đáy tới đỉnh (Bottom to top)" },
        {
          id: 1,
          choice:
            "Cả Đỉnh tới đáy (Top to bottom) và Đáy tới đỉnh (Bottom to top)",
        },
        { id: 2, choice: "Không lựa chọn nào" },
      ],
      answer: 3,
  ...
  CacThuatToanVeDuongThangDuongTron: [
    {
      id: 1,
      question:
        "Phương trình đường thẳng dưới dạng hệ số góc (Cartesian slope-intercept equation) có dạng như sau",
      choice: [
        { id: 0, choice: "y = b.x + m" },
        { id: 3, choice: "y = m.x + b" },
        { id: 1, choice: "y = x.x + m" },
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 0, choice: "Tăng y lên 1 đơn vị rồi tính x" },
        {
          id: 1,
          choice:
            "Cả Tăng x lên 1 đơn vị rồi tính y và Tăng y lên 1 đơn vị rồi tính x",
        },
    ...
    },
    {
      ...
      choice: [
        { id: 3, choice: "Thuật toán vẽ đường thẳng Bresenham" },
        {
          id: 0,
          choice:
            "Thuật toán vẽ đường thẳng dùng đường thẳng hệ số góc đơn giản",
        },
    ...
    },
    {
      id: 6,
      question:
        "Một thuật toán mành hóa vẽ đường thẳng chính xác và hiệu quả là",
      choice: [
        {
          id: 0,
          choice:
    ...
    },
    {
      id: 7,
      question:
        "Trong thuật toán Bresendham vẽ đường thẳng, Nếu d1 < d2 thì tham số quyết định Pk là______",
      choice: [
        { id: 3, choice: "Âm" },
        { id: 0, choice: "Dương" },
    ...
    },
    {
      id: 8,
      question:
        "Thuật toán vẽ đường thẳng nào là tốt nhất trong việc cân bằng tải xử lý giữa các bộ xử lý?",
      choice: [
    ...
    },
    {
      id: 9,
      question:
        "Thuật toán sử dụng nhiều bộ xử lý để tính toán các vị trí của điểm ảnh là",
      choice: [
        { id: 3, choice: "Thuật toán song song vẽ đường thẳng" },
        { id: 0, choice: "Thuật toán DDA vẽ đường thẳng" },
    ...
    },
    {
      id: 10,
      question:
        "Tham chiếu tọa độ trong hàm vẽ chuỗi đường thẳng được chỉ ra như",
      choice: [
        {
          id: 3,
          choice: "Giá trị tọa độ tuyệt đối (Absolute coordinate values",
        },
        { id: 0, choice: "Vị trí hiện tại (Current position)" },
        {
          id: 1,
          choice: "Giá trị tọa độ liên quan (Relative coordinate values)",
        },
    ...
    },
    {
      id: 11,
      question:
        "Để áp dụng phương pháp điểm giữa vẽ đường tròn, chúng ta định nghĩa",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 0,
          choice: "Thuật toán đường cong song song (Parallel curve algorithm)",
        },
        { id: 1, choice: "Thuật toán tô biên (Boundary-fill algorithm)" },
        {
          id: 2,
          choice: "Thuật toán tô màu dòng quét (Scan-line fill algorithm)",
        },
      ],
      answer: 3,
    },
    ...
    },
    {
      id: 16,
      question:
        "Một đường thẳng tô nét đứt (dashed line) được hiển thị bằng cách sinh ra _________.",
      choice: [
    ...
    },
    {
      id: 17,
      question:
        "Một đường thẳng tô dưới dạng điểm (dotted line) có thể được hiển thị bằng cách sinh ra",
      choice: [
        {
          id: 0,
          choice:
            "Very short dashes với khoảng trắng nhỏ hơn hoặc bằng cỡ của dash",
        },
        {
          id: 3,
          choice:
            "Very short dashes với khoảng trắng lớn hơn hoặc bằng cỡ của dash",
        },
        {
          id: 1,
          choice:
            "Very long dashes với khoảng trắng lớn hơn hoặc bằng cỡ của dash",
        },
        { id: 2, choice: "Dots" },
      ],
      answer: 3,
    },
    {
      id: 18,
      question:
        "Lựa chọn nào dưới đây không phải kiểu đường thẳng (line-type)?",
      choice: [
    ...
    },
    {
      id: 19,
      question:
        "Trong một ứng dụng, để thiết lập thuộc tính kiểu đường thẳng (line-type) chúng ta dùng câu lệnh",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 1,
          choice: "Cả Adjacent parallel lines và Adjacent perpendicular lines",
        },
        {
          id: 2,
          choice:
            "Hoặc Adjacent parallel lines hoặc Adjacent perpendicular lines",
        },
      ],
      answer: 3,
    },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Độ rộng của đường thẳng đang vẽ (Relative width of the line)",
        },
        { id: 0, choice: "Độ rộng chuẩn (Standard width)" },
        {
          id: 1,
          choice: "Độ dày của đường thẳng đang vẽ (Thickness of the line)",
        },
    ...
    },
    {
      id: 26,
      question:
        "Chúng ta thiết lập giá trị màu đường thẳng (line-color value) trong PHIGS bằng hàm",
      choice: [
  ...
  CacThuatToanCatXen: [
    {
      id: 1,
      question:
        "Quá trình ánh xạ từ cửa sổ thế giới từ hệ tọa độ thế giới sang viewport được gọi là",
      choice: [
    ...
    },
    {
      id: 3,
      question:
        "Phần hình chữ nhật của một cửa sổ giao diện nơi mà bức ảnh sẽ xuất hiện được gọi là",
      choice: [
    ...
    },
    {
      id: 4,
      question:
        "Hệ tọa độ của cửa sổ nơi đối tượng thật xuất hiện được gọi là .............. ",
      choice: [
    ...
    },
    {
      id: 6,
      question:
        "Vùng chứa đối tượng sau khi bị cắt xén được gọi là ..............",
      choice: [
    ...
    },
    {
      id: 7,
      question:
        "Điền vào phần bỏ trống ............. để xác định vùng ảnh nằm ngoài cửa sổ cắt xén (clip window)",
      choice: [
    ...
    },
    {
      id: 9,
      question:
        "Điền vào phần bỏ trống Mã dùng để mã hóa vùng cửa sổ cắt xén là ............",
      choice: [
        { id: 0, choice: "0001" },
        { id: 3, choice: "0000" },
        { id: 1, choice: "1000" },
      ...
      choice: [
        {
          id: 0,
          choice:
            "Mã của hai đầu mút đoạn thẳng có cùng bit '0' tại cùng vị trí.",
        },
        {
          id: 3,
          choice:
            "Mã của hai đầu mút đoạn thẳng có cùng bit '1' tại cùng vị trí.",
        },
    ...
    },
    {
      id: 12,
      question:
        "Kết quả của phép toán AND với mã của các đầu mút với giá trị khác 0. Câu nào sau đây đúng?",
      choice: [
    ...
    },
    {
      id: 13,
      question:
        "Điền vào phần bỏ trống Bit bên trái (L bit ) của mã của điểm (X,Y) là '1' nếu ......................",
      choice: [
        { id: 0, choice: "X > XWMIN " },
        { id: 3, choice: "X< XWMIN " },
        { id: 1, choice: "X< XWMAX " },
    ...
    },
    {
      id: 14,
      question:
        "Bit bên phải (R bit ) của mã của điểm (X,Y) là '1' nếu......................",
      choice: [
        { id: 0, choice: "X< XWMAX" },
        { id: 3, choice: "X>XWMAX" },
        { id: 1, choice: "X< XWMIN " },
    ...
    },
    {
      id: 15,
      question:
        "Điền vào phần bỏ trống Bit trên đỉnh (T bit ) của mã của điểm (X,Y) là '1' nếu ......................",
      choice: [
        { id: 0, choice: "Y< YWMAX " },
        { id: 3, choice: "Y>YWMAX" },
        { id: 1, choice: "Y< YWMIN " },
    ...
    },
    {
      id: 16,
      question:
        "Bit dưới đáy (B bit ) của mã của điểm (X,Y) là '1' nếu .......................",
      choice: [
        { id: 0, choice: "Y>YWMAX" },
        { id: 3, choice: "Y< YWMIN" },
        { id: 1, choice: "Y< YWMAX " },
    ...
    },
    {
      id: 18,
      question:
        "Phép toán được sử dụng để kiểm tra đoạn thẳng có bị cắt xén hay không.............",
      choice: [
    ...
    },
    {
      id: 19,
      question:
        "Thuật toán Sutherland Hodgeman hoạt động tốt trong trường hợp cắt xén...........",
      choice: [
  ...
  CacPhepBienDoi: [
    {
      id: 1,
      question:
        "Phép biến đổi tịnh tiến được áp dụng cho một đối tượng (object) bằng cách",
      choice: [
        {
          id: 3,
          choice: "Đặt lại vị trí của đối tượng dọc theo một đường thẳng",
        },
        {
          id: 0,
          choice: "Đặt lại vị trí của đối tượng dọc theo một cung tròn",
        },
        {
          id: 1,
          choice: "Chỉ Đặt lại vị trí của đối tượng dọc theo một cung tròn",
        },
    ...
    },
    {
      id: 5,
      question:
        "Phương trình của phép biến đổi tịnh tiến khi điểm biểu diễn dưới dạng tọa độ Đecác là",
      choice: [
        { id: 3, choice: "P’=P+T" },
        { id: 0, choice: "P’=P-T" },
        { id: 1, choice: "P’=P*T" },
    ...
    },
    {
      id: 7,
      question:
        "Một đoạn thẳng được tịnh tiến bằng cách áp dụng phương trình biến đổi",
      choice: [
        { id: 3, choice: "P’=P+T" },
    ...
    },
    {
      id: 9,
      question:
        "Để thay đổi vị trí của một đường tròn hay elip chúng ta tịnh tiến",
      choice: [
    ...
    },
    {
      id: 11,
      question:
        "Một phép quay hai chiều được áp dụng cho một đối tượng bằng cách ",
      choice: [
        {
          id: 0,
          choice: "Đặt lại vị trí của đối tượng dọc theo một đường thẳng",
    ...
    },
    {
      ...
      choice: [
        {
          id: 0,
          choice: "Góc quay ngược chiều kim đồng hồ xung quanh điểm cần quay",
        },
        {
          id: 3,
          choice: "Góc quay ngược chiều kim đồng hồ xung quanh tâm quay",
        },
    ...
    },
    {
      id: 14,
      question:
        "Trục quay vuông góc với mặt phẳng xy và đi qua một điểm chốt được gọi là",
      choice: [
    ...
    },
    {
      id: 19,
      question:
        "Chỉ ra phép biến đổi được sử dụng để thay đổi kích cỡ của đối tượng",
      choice: [
        { id: 3, choice: "Co dãn" },
        { id: 0, choice: "Quay" },
    ...
    },
    {
      id: 24,
      question:
        "Các đối tượng được biến đổi theo phương trình P’=S*P có thể là",
      choice: [
    ...
    },
    {
      id: 25,
      question:
        "Chúng ta kiểm soát vị trí của đối tượng bị co dãn bắng cách chọn một điểm được biết đến là",
      choice: [
    ...
    },
    {
      id: 28,
      question:
        "Biểu diễn dạng ma trận của phép tịnh tiến trong hệ tọa độ đồng là",
      choice: [
        { id: 3, choice: "P’=T*P" },
        { id: 0, choice: "P’=T+P" },
        { id: 1, choice: "P’=S*P" },
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 1, choice: "Phép co dãn không thể thực hiện được" },
        {
          id: 2,
          choice:
            'Không phải lựa chọn "Phép biến đổi là phép co dãn không đồng nhất "cũng không phải lựa chọn Phép biến đổi là phép co dãn đồng nhất"',
        },
      ],
      answer: 3,
    },
    {
      id: 30,
      question:
        "Biểu diễn mà trận cho biến đổi co dãn trong hệ tọa độ đồng nhất là",
      choice: [
        { id: 0, choice: "P’=dx+dy" },
        { id: 3, choice: "P’=S*P" },
        { id: 1, choice: "P’=dx+dy" },
    ...
    },
    {
      id: 32,
      question:
        "Việc sử dụng của hệ tọa độ đồng nhất và biểu diễn ma trận là để",
      choice: [
        { id: 0, choice: "Thực hiện phép kéo" },
        {
          id: 3,
          choice: "Biểu diễn các phép biến đổi theo một cách đồng nhất",
        },
    ...
    },
    {
      id: 34,
      question:
        "Trong phép biến đổi hai chiều giá trị thành phần tọa độ thứ 3 w=?",
      choice: [
        { id: 3, choice: 1 },
        { id: 0, choice: 0 },
        { id: 1, choice: -1 },
    ...
    },
    {
      id: 36,
      question:
        "Biểu diễn tọa độ trong hệ trục tọa độ đồng nhất có thể viết như sau",
      choice: [
  ...
  XacDinhBeMatHien: [
    {
      id: 1,
      question:
        "Các bề mặt bị khóa hoặc ẩn trong khung cảnh 3 chiều được gọi là",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 1,
          choice: "Nhận diện các bề mặt ẩn (Identification of hidden surface)",
        },
        { id: 2, choice: "Không lựa chọn nào" },
      ],
      answer: 3,
      ...
      choice: [
        {
          id: 3,
          choice:
            "Cả Để hiển thị cảnh thực và Để xác định bề mặt hiện gần nhất",
        },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Cả Chính xác theo đối tượng (Object-space method) và Chính xác theo ảnh (Image-space method)",
        },
    ...
    },
    {
      ...
      choice: [
        ...
        { id: 0, choice: "Chính xác theo đối tượng (Object-space method)" },
        {
          id: 1,
          choice:
            "Cả Chính xác theo ảnh (Image-space method) và Chính xác theo đối tượng (Object-space method)",
        },
        { id: 2, choice: "Không lựa chọn nào" },
      ],
      answer: 3,
    },
    {
      ...
      choice: [
        { id: 3, choice: "Tất cả các đáp án trên" },
        {
          id: 0,
          choice:
            "So sánh độ sâu, Z-buffẻ, loại bỏ mặt quay vào trong (Depth comparison, Zbuffer, back-face removal)",
        },
        {
          id: 1,
          choice:
            "Thuật toán dòng quét, thuật toán ưu tiên (Scan line algorithm, priority algorithm)",
        },
        {
          id: 2,
          choice:
            "Phân hoạch nhị phân, chia nhỏ vùng (BSP method, area subdivision method)",
        },
      ],
      answer: 3,
    },
    ...
    },
    {
      id: 12,
      question:
        "Kiểu cây nào của cấu trúc dữ liệu mà mỗi nút trong có 4 nút con",
      choice: [
  ...
  DuongCongVaBeMat: [
    ...
    },
    {
      ...
      choice: [
        {
          id: 3,
          choice: "Các nhịp ngang hoặc dọc (Horizontal and vertical spans)",
        },
    ...
    },
    {
      ...
      choice: [
        {
          id: 3,
          choice: "Thuật toán đường cong mành (Raster curve algorithm)",
        },
        {
          id: 0,
          choice: "Thuật toán đường thẳng mành (Raster line algorithm)",
        },
        { id: 1, choice: "Thuật toán quét mành (Raster scan algorithm)" },
        {
          id: 2,
          choice: "Thuật toán đường cong ngẫu nhiên (Random curve algorithm)",
        },
      ],
      answer: 3,
    },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Để hiện thị mẫu gạch (dashes) và khoảng trống giữa các mẫu gạch (inter dash spaces) theo hệ số góc",
        },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Mảnh hơn và hệ số góc nhỏ hơn 1 (Thicker and magnitude slope is 1)",
        },
        { id: 0, choice: "Mảnh hơn (Thinner)" },
        {
          id: 1,
          choice:
            "Dày hơn và hệ số góc lớn hơn 1 (Thicker and magnitude slope >1",
        },
      ],
      answer: 3,
    },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Cả Đường spline mở (Open spline) và Đường spline đóng (Closed spline)",
        },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Cả Đơn giản để tính toán và Cung cấp các đường cong liên tục",
        },
  ...
  AnhSang: [
    ...
    },
    {
      id: 7,
      question:
        "Kỹ thuật tạo bóng nào dưới dây cho phép miêu tả điểm sang (specular highlights)?",
      choice: [
        { id: 0, choice: "flat" },
        { id: 3, choice: "Phong" },
        { id: 1, choice: "Gouraud" },
      ...
      choice: [
        {
          id: 0,
          choice:
            "Tạo bóng Phong giả định cùng một vectơ pháp tuyến được áp dụng cho mọi điểm ảnh trên bề mặt",
        },
        {
          id: 3,
          choice:
        ...
        { id: 1, choice: "Tạo bóng Gouraud luôn có điểm sáng" },
        {
          id: 2,
          choice:
            "Tạo bóng cố định (Constant) yêu cầu tính toán phức tạp hơn tạo bóng Phong",
        },
      ],
      answer: 3,
    },
    ...
    },
    {
      ...
      choice: [
        {
          id: 3,
          choice: "các kênh đỏ, xanh lá, xanh dương được tính độc lập.",
        },
        {
          id: 0,
          choice: "các kênh đỏ, xanh lá, xanh dương được tính cùng nhau.",
        },
  ...
  OpenGL: [
    {
      ...
      choice: [
        ...
        {
          id: 3,
          choice: "Chỉ rõ kiểu dữ liêu (int, float, pointer, double, …)",
        },
        { id: 1, choice: "Chỉ rõ kiểu dữ liêu trong OpenGL được viết cho CPU" },
        {
          id: 2,
          choice:
            "Đặc tả đầu ra (Ví dụ: immediate mode, frame buffer, virtual mode, double-buffer,\r\n…)",
        },
      ],
      answer: 3,
    },
    ...
    {
      question:
        "Chúng ta phải làm gì để quay đối tượng quanh một điểm không phải gốc tọa độ?",
      choice: [
        { id: 0, choice: "Phép quay chỉ thực hiện được quanh gốc tọa độ" },
        {
          id: 3,
          choice:
            "Dịch đối tượng tới gốc tọa độ, xoay quah gốc tọa độ sau đó dịch tới vị trí ban đầu",
        },
        {
          id: 1,
          choice:
            "Thực hiện câu lệnh glRotate và chỉ rõ điểm mà đối tượng quay quanh",
        },
        {
          id: 2,
          choice:
    ...
    },
    {
      ...
      choice: [
        { id: 0, choice: "glMaterialf(…) thực hiện chức năng?" },
        {
          id: 3,
          choice:
            "Định nghĩa thuộc tính chất liệu của đối tượng được vẽ cho hiệu ứng hiển thị",
        },
        {
          id: 1,
          choice: "Chuyển sang chế độ chất liệu để thêm hiệu ứng hiển thị",
        },
    ...
    {
      question:
        "Dạng đa giác nào hoạt động tốt nhất trong VBO để mô hình hóa đối tượng đặc\r\n(solid)?",
      choice: [
    ...
    },
    {
      ...
      choice: [
        ...
        {
          id: 0,
          choice: "Thông tin chia sẻ ngũ cảnh (Context-sharing Information)",
        },
    ...
    },
    {
      ...
      choice: [
        { id: 0, choice: "Một số nằm trong khoảng 0 và 255" },
        {
          id: 3,
          choice:
            "GL_KEEP, GL_ZERO,GL_REPLACE, GL_INCR, GL_INCR_WRAP,\r\nGL_DECR, GL_DECR_WRAP, GL_INVERT",
        },
        { id: 1, choice: "TRUE hoặc FALSE" },
        {
          id: 2,
          choice: "GL_R, GL_G, GL_B, GL_RGB, GL_RGBA, GL_ARGB, GL_BGRA",
        },
      ],
      answer: 3,
    },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Phép toán được sử dụng thể tạo các di chuyển của các điểm và đối tượng theo\r\nmong muốn",
        },
        { id: 0, choice: "Chuyển qua lại giữa các bộ đệm" },
        {
          id: 1,
          choice:
            "Hàm của OpenGL dùng để biến dạng (morph) đa giác thành đa giác khác.",
        },
    ...
    {
      question:
        "Nếu không bật nguồn sáng, hàm nào dưới đây chỉ rõ màu của các đỉnh?",
      choice: [
        { id: 3, choice: "glColor()" },
      ...
      choice: [
        {
          id: 3,
          choice:
            "glColor3d có tham số kiểu double trong khi glColor3f có tham số kiểu float",
        },
        {
          id: 0,
          choice:
            "glColor3d chỉ thiết lập RGB, trong khi glColor3f thiết lập R,G,B và A",
        },
        {
          id: 1,
          choice:
            "glColor3d cho phép thao tác với màu 3d trong khi glColor3f chỉ cho phép 8-bit\r\nmàu",
        },
        {
          id: 2,
          choice:
            "glColor3d trong không gian thực trong khi glColor3f trong không gian số nguyên",
        },
      ],
      answer: 3,
    },
    ...
    {
      question:
        "Câu lệnh dùng để vẽ các hình nguyên thủy trong OpenGL (OpenGL primitives).",
      choice: [
    ...
    },
    {
      ...
      choice: [
        {
          id: 0,
          choice: "Các thông tin lũy thửa để phân tích dữ liệu dạng sóng",
        },
        {
          id: 3,
          choice:
        ...
        },
        {
          id: 1,
          choice:
            "Thông tin tài nguyên của chương trình như trees, lists và data types",
        },
      ...
      choice: [
        {
          id: 3,
          choice:
            "Một kiểu bộ đệm tích lũy thông tin độ sâu trong khung cảnh 3 chiều",
        },
    ...
    {
      question:
        "OpenGL có cung cấp các đối tượng nguyên thủy như cube, cone, pyramid?",
      choice: [
        {
          id: 3,
          choice:
            "Không chính thức trong đặc tả của OpenGL nhưng các đối tượng này được cung\r\ncấp bởi thư viện GLUT",
        },
        {
          id: 0,
          choice:
            "Có nhưng phải dùng glEnable(GL_PRIMITIVES) trước câu lệnh glBegin",
        },
        { id: 1, choice: "Có" },
    ...
    {
      question:
        "OpenGL sử dụng mô hình client-server và một máy trạng thái (state machine)?",
      choice: [
    ...
    {
      question:
        "Tổ chức chịu trách nhiệm cho các chuẩn và phát triển của OpenGL?",
      choice: [
        { id: 0, choice: "Crysis" },
        { id: 3, choice: "Khronos" },
        { id: 1, choice: "Cryptic" },
    ...
    },
    {
      ...
      choice: [
        {
          id: 3,
          choice: "Lặp lại ảnh chất liệu theo một hướng (ngang hoặc dọc)",
        },
    ...
    {
      question:
        "OpenGL có cung cấp hiệu ứng vật lý (physics), hệ thống hạt (particle systems)?",
      choice: [
    ...
    {
      question:
        "Các giá trị “R”, “G”, “B” và “A” trong ngữ cảnh màu sắc có ý nghĩa gì?",
      choice: [
    ...
    {
      question:
        "Loại mảng đỉnh (vertex array) nào không được cung cấp bởi OpenGL?",
      choice: [
